...
def main(args):
    ...
    adaptive = Encoder2Decoder(args.embed_size, len(vocab), args.hidden_size, args.prompt_size, args.word_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./models_new',
    ...
    parser.add_argument('--learning_rate_cnn', type=float, default=5e-5,
    ...
    parser.add_argument('--prompt_size', type=int, default=60,
                        help='prompt size for the attention module')
    parser.add_argument('--word_size', type=int, default=30,
                        help='word size for the attention module')
